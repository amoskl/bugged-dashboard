...
function App() {
  ...
  // Filter logic - fixed to properly compare dates
  ...
  // Mark complete function - fixed to update UI state
  const markComplete = async (taskId) => {
    ...
    // Fixed: Update the UI state after the API call
  ...
  // Handle task hover - fixed to avoid undefined property access
  const handleTaskHover = (task) => {
    // Fixed: Check if category exists before accessing it
    console.log(`Hovering over task: ${task.title}${task.category ? ` (Category: ${task.category.name})` : ''}`)
  }
